...
//			System.out.print(email+" "+cate);
			...
			while (rs.next()) {
				ba = new BookDtls();
				ba.setBookId(rs.getInt(1));
				ba.setBookName(rs.getString(2));
				ba.setAuthor(rs.getString(3));
				ba.setPrice(rs.getString(4));
				ba.setBookCategory(rs.getString(5));
				ba.setStatus(rs.getString(6));
				ba.setPhotoName(rs.getString(7));
				ba.setEmail(rs.getString(8));
				list.add(ba);
